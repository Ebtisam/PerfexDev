        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row" style="margin: 15px;">
                    ...
                    <?php echo form_open_multipart(site_url('spreadsheet_online/spreadsheet_online_client/file_word_view_share/'.$parent_id),array('id'=>'word-file-form'));?>
                    <input data-tips="Doc rename" id="word_info_detail_input" class="" value="Untitled document" tabindex="0" dir="ltr" aria-label="Rename" style="visibility: visible; width: 220px;" data-tooltip="Rename">
                    <a href="<?php echo site_url('spreadsheet_online/manage'); ?>" id="luckysheet_info_detail_close" class="btn btn-danger luckysheet_info_detail_close"> <i class="fa fa-window-close" aria-hidden="true"></i> Close </a>
